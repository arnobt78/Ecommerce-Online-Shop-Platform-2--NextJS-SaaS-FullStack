...
const HeroStats = () => {
  return (
    <div className="w-full bg-transparent">
      <div className="flex flex-row justify-start w-full bg-transparent">
        {stats.map((item, idx) => (
          <React.Fragment key={item.text}>
            <div
              className={`flex-1 flex flex-col items-center justify-center bg-transparent px-3 py-3`}
            >
              <div className="flex flex-col items-center justify-center h-full">
                <div className="text-2xl sm:text-4xl font-semibold text-gray-900 mb-1 text-center">
                  <CountUp
                    end={item.num}
                    duration={2}
                    delay={0.5}
    ...
    <div className="flex flex-col justify-center items-start w-full max-w-xl mx-auto sm:mx-0 bg-transparent">
      ...
      <div className="flex items-center space-x-2">
        <svg width="20" height="16" viewBox="0 0 20 16" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M4.27372 15.7423L5.83717 10.0608L0.593597 6.23945L7.52088 5.73398L10.2148 0.376007L12.9088 5.73398L19.8361 6.23945L14.5925 10.0608L16.1559 15.7423L10.2148 12.7297L4.27372 15.7423Z" fill="black"/>
        </svg>
      ...
      <h3 className="text-xl sm:text-3xl text-gray-900 leading-tight whitespace-wrap sm:whitespace-nowrap mb-8 z-30 items-left sm:items-center">
        Choose from huge <br className="block sm:hidden" /> sortiment of exclusive<br />
        brands, flavors and <br className="block sm:hidden" />strength <br className="hidden sm:block" />
        for best price on market<br className="hidden sm:block" />
        with free shipping.
      </h3>
      {/* CTA Button */}
      <div className="button-wrapper mb-12 relative inline-block" style={{ width: '170px', height: '56px' }}>
        {/* Rotating border overlay - always on top, outside button/link */}
        <div className="rotating-border pointer-events-none absolute inset-0 z-50" style={{ width: '170px', height: '56px' }}>
          <svg width="100%" height="100%" viewBox="0 0 180 60" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full" style={{ borderRadius: '16px' }}>
            <rect
              x="1"
              y="1"
              width="170"
            ...
            />
            <defs>
              <linearGradient id="border-gradient" x1="0" y1="0" x2="170" y2="56" gradientUnits="userSpaceOnUse">
        ...
        <Link href="/products">
          <button
            ...
            style={{ minWidth: '160px', minHeight: '54px', borderRadius: '16px', zIndex: 10 }}
            type="button"
          >
            <span>Buy now</span>
