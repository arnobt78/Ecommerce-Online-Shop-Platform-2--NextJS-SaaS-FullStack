...
export default function DashboardSettingSidebar({
  onTabChange,
}: DashboardSettingSidebarProps) {
  const { t } = useLanguage();
  ...
  const menu = [
    {
      ...
      icon: (
        ...
        >
          <path
            d="M19.849 11.0614L2.51459 0.743373C2.31225 0.62294 2.08162 0.55826 1.84616 0.555913C1.61071 0.553567 1.37883 0.613638 1.17413 0.730013C0.96943 0.846389 0.799213 1.01492 0.6808 1.21844C0.562386 1.42197 0.500004 1.65324 0.5 1.88871V22.112C0.500275 22.3453 0.561768 22.5745 0.678339 22.7767C0.79491 22.9788 0.962478 23.1469 1.16431 23.264C1.36614 23.3811 1.59517 23.4433 1.82853 23.4442C2.06189 23.4451 2.2914 23.3848 2.49416 23.2693L19.8284 13.3641C20.0307 13.2486 20.1992 13.082 20.317 12.881C20.4348 12.68 20.4979 12.4517 20.4999 12.2187C20.502 11.9857 20.443 11.7563 20.3287 11.5533C20.2145 11.3502 20.049 11.1807 19.8488 11.0615L19.849 11.0614ZM2.27717 21.3464V2.67022L18.2853 12.1989L2.27717 21.3464Z"
            fill="black"
          />
        </svg>
      ),
    ...
    },
    {
      ...
      icon: (
        ...
        >
          <path
            d="M3.0518 10.668H14.4908V10.668V9.33469V9.33465H3.0518L6.17835 6.20744V6.2074L5.23571 5.26465L0.5 10.0013L0.500042 10.0014H0.5L5.23571 14.7381L6.17835 13.7953V13.7952L3.0518 10.668Z"
            fill="black"
          />
          <path
            d="M6.50293 0V1.33333H19.1669V18.6667H6.50293V20H20.5V0H6.50293Z"
            fill="black"
          />
        </svg>
      ),
  ...
  return (
    <aside className="w-full bg-white rounded-2xl shadow-sm flex flex-col items-center py-4 px-4">
      <div className="flex flex-col gap-4 w-full items-center ">
        <button
          className={`w-full flex items-center gap-2 py-3 px-4 rounded-xl font-semibold text-base mb-2 transition-colors duration-300 ${
            activeTab === "Course"
              ? "bg-[#6DF4F9]/20 text-gray-900"
        ...
        <button
          className={`w-full flex items-center gap-2 py-3 px-4 rounded-xl font-semibold text-base transition-colors duration-300 ${
            activeTab === "Logout"
              ? "bg-[#6DF4F9]/20 text-gray-900"
              : "bg-white border border-gray-200 text-gray-700 hover:bg-gray-200"
          }`}
