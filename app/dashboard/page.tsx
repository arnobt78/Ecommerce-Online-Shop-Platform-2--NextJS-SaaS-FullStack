    ...
    <div className="min-h-screen bg-[#F8F9FB]">
      ...
      <div className="block sm:hidden w-full flex flex-col items-center">
        ...
        <div className="w-full flex justify-center pt-6 pb-2">
          <svg width="180" height="40" viewBox="0 0 212 40" fill="none" xmlns="http://www.w3.org/2000/svg" className="mb-4">
        ...
        {/* Main content: video screen and buttons */}
        <div className="w-full flex flex-col items-center">
          {mainContent}
        </div>
      {/* Video list sidebar below video: only show when Course tab is active */}
      {activeTab === 'Course' && (
        ...
        {/* Settings sidebar below video list */}
