 ...
 */
export const StockStatusLabel: React.FC<StockStatusLabelProps> = ({ stockStatus, labelClassName }) => {
  let color = '#15FF00';
  ...
  return (
    <>
      <span className="inline-block w-2 h-2 rounded-full mr-1" style={{ backgroundColor: color, boxShadow: shadow }} />
