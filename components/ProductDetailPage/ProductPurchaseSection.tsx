...
/**
 * PriceDisplay shows the calculated price for the selected quantity, with discount if applicable.
 */
...
// --- Inlined: ProductPurchaseActions ---
interface ProductPurchaseActionsProps {
  onBuyNow: () => void;
  onAddToCart: () => void;
}
/**
 * ProductPurchaseActions renders Buy Now and Add to Cart buttons.
 */
...
// --- Inlined: GuaranteeShippingReturns ---
/**
  ...
  return (
    <div className="flex flex-row justify-between items-center bg-[#8EF7FB]/12 px-0 sm:px-4 py-4 sm:py-4 gap-1 sm:gap-2">
      <span className="flex-1 sm:flex-none text-center text-xs sm:text-sm text-[#343232]">
        {t("productDetail.moneyBackGuarantee")}
      </span>
      <span className="flex-1 sm:flex-none text-center text-xs sm:text-sm text-[#343232]">
    ...
    <div className="flex flex-col gap-4 py-2 w-full px-4 sm:px-0">
      <div className="flex flex-row items-center gap-4">
        ...
        <span className="inline-flex items-center justify-center w-7 h-7">
          ...
          >
            <path
              d="M11.1398 27.0508C12.6778 27.0508 13.9246 25.8041 13.9246 24.266C13.9246 22.728 12.6778 21.4812 11.1398 21.4812C9.60179 21.4812 8.35498 22.728 8.35498 24.266C8.35498 25.8041 9.60179 27.0508 11.1398 27.0508Z"
              stroke="black"
              strokeWidth="1.67"
            ...
            />
            <path
              d="M25.0636 27.0508C26.6017 27.0508 27.8485 25.8041 27.8485 24.266C27.8485 22.728 26.6017 21.4812 25.0636 21.4812C23.5256 21.4812 22.2788 22.728 22.2788 24.266C22.2788 25.8041 23.5256 27.0508 25.0636 27.0508Z"
              stroke="black"
              strokeWidth="1.67"
              strokeMiterlimit="1.5"
              strokeLinecap="round"
            ...
            />
            <path
              d="M13.9944 24.266H20.8868V9.78494C20.8868 9.32354 20.5128 8.94949 20.0514 8.94949H1.39307"
              stroke="black"
              strokeWidth="1.67"
              strokeLinecap="round"
            />
            <path
              d="M7.86762 24.266H5.01318C4.55178 24.266 4.17773 23.892 4.17773 23.4306V16.6078"
              stroke="black"
              strokeWidth="1.67"
              strokeLinecap="round"
            />
            <path
              d="M2.78467 13.1267H8.35431"
              stroke="black"
              strokeWidth="1.67"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            <path
              d="M20.8867 13.1267H28.6983C29.0284 13.1267 29.3277 13.3212 29.4617 13.6229L31.954 19.2305C32.0015 19.3375 32.026 19.453 32.026 19.5698V23.4306C32.026 23.892 31.652 24.266 31.1906 24.266H28.545"
              stroke="black"
              strokeWidth="1.67"
              strokeLinecap="round"
            />
            <path
              d="M20.8867 24.266H22.2789"
              stroke="black"
              strokeWidth="1.67"
              strokeLinecap="round"
            />
        ...
        <div className="flex flex-col">
          <span className="font-medium text-[13px] text-gray-900 leading-tight">
            {t("productDetail.freeShippingLabel")}
          </span>
          <span className="text-[13px] text-gray-400 leading-tight">
            {t("productDetail.businessDays")}
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-row items-center pt-2 gap-4">
        ...
        <span className="inline-flex items-center justify-center w-7 h-7">
          ...
          >
            <path
              d="M3.36719 11.1401V21.1655C3.36719 22.396 4.36463 23.3934 5.59505 23.3934H21.1901C22.4205 23.3934 23.4179 22.396 23.4179 21.1655V11.1401"
              stroke="black"
              strokeWidth="1.67"
            />
            <path
              d="M16.5483 23.3934V16.7098C16.5483 15.4793 15.5509 14.4819 14.3205 14.4819H12.0926C10.8622 14.4819 9.86475 15.4793 9.86475 16.7098V23.3934"
              stroke="black"
              strokeWidth="1.67"
              strokeMiterlimit="16"
            />
            <path
              d="M24.3296 10.4319L22.4426 3.82738C22.3607 3.54045 22.0984 3.34263 21.8 3.34263H17.2915L17.821 9.69622C17.8383 9.90415 17.9513 10.092 18.1305 10.1988C18.5642 10.4573 19.4138 10.9363 20.0763 11.1401C21.2079 11.4882 22.862 11.3627 23.8041 11.2468C24.1959 11.1987 24.4381 10.8114 24.3296 10.4319Z"
              stroke="black"
              strokeWidth="1.67"
            />
            <path
              d="M15.6211 11.1401C16.2533 10.9456 17.0558 10.5006 17.5047 10.2357C17.7184 10.1096 17.8361 9.8714 17.8155 9.62412L17.292 3.34263H9.49453L8.97107 9.62412C8.95046 9.8714 9.06815 10.1096 9.28184 10.2357C9.73076 10.5006 10.5333 10.9456 11.1654 11.1401C12.8285 11.6519 13.958 11.6519 15.6211 11.1401Z"
              stroke="black"
              strokeWidth="1.67"
            />
            <path
              d="M4.34166 3.82738L2.45466 10.4319C2.34622 10.8114 2.58848 11.1987 2.98025 11.2468C3.92226 11.3627 5.57653 11.4882 6.70802 11.1401C7.37055 10.9363 8.22019 10.4573 8.65381 10.1988C8.83303 10.092 8.94605 9.90415 8.96338 9.69622L9.49284 3.34263H4.9843C4.68589 3.34263 4.42364 3.54045 4.34166 3.82738Z"
              stroke="black"
              strokeWidth="1.67"
            />
          </svg>
        ...
        <div className="flex flex-col">
          <span className="font-medium text-[13px] text-gray-900 leading-tight">
            {t("productDetail.pickupFromWarehouse")}
          </span>
          <span className="text-[13px] text-gray-400 leading-tight">
            {t("productDetail.todayWroclaw")}
          </span>
        </div>
      </div>
    </div>
...
export const ProductPurchaseSection: React.FC<ProductPurchaseSectionProps> = ({
  ...
  return (
    <div className="w-full max-w-[687px] flex flex-col gap-0 sm:gap-6 px-1 sm:px-0">
      ...
      {/* Quantity and Price */}
      <div className="flex flex-row items-center mt-2 mb-2 sm:mt-0 sm:mb-0 flex-wrap justify-between">
        <div className="flex flex-row w-full items-center justify-between">
          {/* Quantity Dropdown Left */}
          <div className="relative">
            <ProductQuantityDropdownSection
              value={quantity}
