...
export default function LoginPage() {
    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-white px-4">
      <div className="w-full flex flex-col items-center justify-center" style={{ minHeight: "100vh" }}>
        ...
        <div className="mb-2 flex flex-col items-center">
          <svg width="180" height="40" viewBox="0 0 212 40" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  Enter the OTP code, sent to <span className="font-semibold">{email}</span>
            ...
            {timer > 0 ? (
              <div className="text-md text-gray-500 mt-2">Resend code in <span className="text-md text-red-500 font-semibold">{timer}s</span></div>
            ) : (
              <button
                type="button"
                className="text-[#01DAE3] text-md font-semibold mt-2 hover:underline bg-[#01DAE3]/10"
